...
class StructureTest:
    ...
    def readConfig(self, *pathConfig, listSection = []):
        ...
        for path in pathConfig:
            ...
            try :
                config[refElement] = {key : configParser.get(section, key) for section in sections for key in configParser.options(section)}
...
if __name__ == "__main__":
    ...
    listPathConfig = ["C:/Users/jules/Documents/Git/BenchSite/repository/targets/bnlearn","C:/Users/jules/Documents/Git/BenchSite/repository/targets/pgmpy","C:/Users/jules/Documents/Git/BenchSite/repository/targets/pyAgrum"]
    test = StructureTest()
