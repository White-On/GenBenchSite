...
from genbenchsite.src.ranking import RankingLibraryGlobal, RankingLibraryByTask, RankingLibraryByTheme
...
class BenchSite:
    ...
    def GenerateHTMLRankingPerThemeName(themeName):
        HTMLThemeRanking = ""
        rankLibraryByTheme = RankingLibraryByTheme(
            threshold=BenchSite.LEXMAX_THRESHOLD
        )
        ...
        for taskName in Task.GetAllTaskName():
            ...
            HTMLTaskRanking = staticSiteGenerator.CreateHTMLComponent(
                ...
                libraryOrdered=BenchSite.OrderedList(
                    RankingLibraryByTask(threshold=BenchSite.LEXMAX_THRESHOLD)[
                        taskName
                    ]
                ),
